package com.mindtree.mystay.admin.feignclient;
...
@SpringBootTest
public class CatalogServiceProxyTest {
	...
	public void testAddHotels() {
		...
		ResponseEntity<List<Hotel>> responseOk = catalogServiceProxy.addHotels(hotels);
	...
	public void testupdateHotel() {
		...
		ResponseEntity<Hotel> responseOk = catalogServiceProxy.updateHotel(hotel.getHotelId(), hotel);
		assertEquals(HttpStatus.OK, responseOk.getStatusCode());
	...
	public void testDeleteHotel() {
		...
		ResponseEntity<String> responseOk = catalogServiceProxy.deleteHotel(hotelId);
		assertEquals(HttpStatus.OK, responseOk.getStatusCode());
	...
	public void testUpgradeOffer() {
		...
		ResponseEntity<String> responseOk = catalogServiceProxy.upgradeOffer(offer, hotelId);
		assertEquals(HttpStatus.OK, responseOk.getStatusCode());
	    ...
	    responseOk = catalogServiceProxy.upgradeOffer(offer, hotelId);
		assertEquals(HttpStatus.OK, responseOk.getStatusCode());
	}
	...
	public void testAddRooms() {
		...
		ResponseEntity<Hotel> responseOk = catalogServiceProxy.addRooms(hotelId, rooms);
		assertEquals(HttpStatus.OK, responseOk.getStatusCode());
	...
	public void testUpdateRoom() {
		...
		ResponseEntity<Hotel> responseOk = catalogServiceProxy.updateRoom(room, hotelId, roomId);
		assertEquals(HttpStatus.OK, responseOk.getStatusCode());
	}
	...
	public void testDeleteRoom() {
		...
		ResponseEntity<Hotel> responseOk = catalogServiceProxy.deleteRoom(hotelId, roomId);
		assertEquals(HttpStatus.OK, responseOk.getStatusCode());
